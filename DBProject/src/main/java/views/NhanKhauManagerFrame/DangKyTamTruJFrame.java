...
public class DangKyTamTruJFrame extends javax.swing.JFrame {
    ...
    private boolean checkCMT(String cmt) {
        if (cmt.trim().isEmpty()) {
            ...
            try {
                ...
                JOptionPane.showMessageDialog(this, "Vui lòng nhập đúng định dạng số CMT/CCCD!", "Warning", JOptionPane.WARNING_MESSAGE);
            }
        }
        return true;
    }
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addComponent(tuNgayDc, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(denNgayDc, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(soDienThoaiJtf, javax.swing.GroupLayout.Alignment.LEADING))
                        .addGap(55, 55, 55))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            ...
                            .addComponent(soCmtJtf, javax.swing.GroupLayout.Alignment.LEADING))
    ...
    private void checkBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_checkBtnActionPerformed
        if (checkCMT(soCmtJtf.getText())) {
            ...
            if (idNhanKhau > 0) {
                ...
                if (JOptionPane.showConfirmDialog(null, "Không tìm thấy người có số CMT/ CCCD: " + soCmtJtf.getText() + ". Thêm mới?", "Confirm", JOptionPane.YES_NO_OPTION) == JOptionPane.OK_OPTION) {
    ...
    private boolean validateForm() {
        return !(soDienThoaiJtf.getText().trim().isEmpty()
